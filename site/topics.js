...
window.TOPICS = [
...

  {
    ...
    icon:       "🎯",
    difficulty: "advanced",
    summary:    "End-to-end recommender-system interview guide: exposure logging, candidate-source fusion, retrieval models, negative sampling, ANN search, ranking, ordered-slate reranking, counterfactual evaluation, feedback loops, experiments, and fairness.",
    subtopics:  [
      "Interview Answer Spine",
      ...
      "Candidate Source Fusion — budgets, deduplication, quotas, RRF, source-aware features",
      "Ranking Methods: GBDT, Wide & Deep, DeepFM, DCN, DLRM, DIN",
      "Ordered-Slate Reranking — MMR, DPP, diversity, position-aware constraints",
      "Negative Sampling - in-batch, hard, exposure-aware, false-negative filtering, sampled-softmax correction",
      "Loss Functions for retrieval, ranking, and multi-task learning",
      "Evaluation Metrics — candidate recall, Recall@K, NDCG, MAP, MRR, calibration",
      "Propensity-Weighted Learning and Off-Policy Evaluation — IPS, SNIPS, doubly robust",
      "Production Feedback Loops — exposure, labels, retraining, ecosystem health",
      "Exploration, Bandits, Feedback Loops, and Fairness",
      "Scenario-Based Model Selection",
    ],
    tags:  ["recommendation", "recommender systems", "rec sys", "collaborative filtering", "matrix factorization", "implicit als", "wrmf", "bpr", "two tower", "two-tower", "candidate fusion", "source fusion", "reciprocal rank fusion", "negative sampling", "in-batch negatives", "hard negatives", "exposure-aware negatives", "false negatives", "sampled softmax", "ann", "faiss", "hnsw", "ranking", "reranking", "slate optimization", "ndcg", "mrr", "map", "cold start", "counterfactual evaluation", "off-policy evaluation", "ips", "snips", "doubly robust", "propensity", "feedback loop", "bandits", "fairness", "diversity"],
...

  {
    ...
    subtopics:  [
      "Core Agent Anatomy — structured state, memory, knowledge retrieval, planner, tools",
      ...
      "Dense Retrieval — exact, HNSW, IVF/PQ; FAISS, ScaNN, vector database implementations",
      ...
      "Tool Reliability — retry classification, idempotency, unknown outcomes, concurrency",
      "Agentic Dataset Design and Regression Tests",
      "Trace-Level Evaluation — deterministic invariants plus calibrated semantic judges",
      ...
      "Model Routing — task/risk routing, cascading, measured quality-latency-cost frontier",
...

  {
    ...
    difficulty: "advanced",
      ...
      subtopics:  [
        ...
        "Adaptation on Three Axes — objective, trainable-parameter scope, deployment form",
        "Catastrophic Forgetting — Replay buffers, EWC, small LR",
        "LoRA — Low-rank ΔW = B·A; rank r; which layers to adapt",
        "QLoRA — LoRA over a frozen low-bit base for memory-efficient adaptation",
        "PEFT Methods — Prompt tuning, prefix tuning, bottleneck adapters, IA3, LoRA, DoRA, AdaLoRA",
        "RAG Architecture — multi-source retrieval, filtering, fusion, reranking, context, generation",
        ...
        "Embeddings & Vector Search - ANN, HNSW, FAISS, ScaNN, IVF/PQ",
        ...
        "Sycophancy and Agentic Preference Data - truthful correction, safe refusal, trajectory labels",
        "LLM Evaluation — perplexity as a diagnostic, task metrics, calibrated semantic judges",
        "Scaling Laws — Kaplan, Chinchilla, lifecycle-cost and metric-dependent scaling",
        ...
        "Hallucination Mitigation — evidence quality, verification, citation validation, abstention",
        "Lost in the Middle — position sensitivity, distractor interference, measured mitigations",
        "Long-Context Interference — stale history, conflicts, distractors, targeted retrieval",
    ],
